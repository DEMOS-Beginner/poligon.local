...
@section('content')
	<div class="container">
						...
						<table class="table table-hover">
							...
							<tbody>
								@foreach($paginator as $item)
									@php /** @var \App\Models\BlogCategory $item */ @endphp <!--Это для нормальной IDE, сделает ITEM ссылкой на файл модели -->
									<tr>
										<td>{{ $item->id }}</td>
										<td>
		...
		@if($paginator->total() > $paginator->count()) <!--Если общее количество записей больше записей в наборе-->
			<br>
			<div class="row justify-content-center">
				<div class="col-md-12">
					<div class="card">
